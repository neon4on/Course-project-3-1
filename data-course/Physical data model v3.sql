...
-- Добавление индексов на внешние ключи для повышения производительности
CREATE INDEX idx_product_categoryId ON Product(categoryId);
CREATE INDEX idx_productItem_productId ON ProductItem(productId);
CREATE INDEX idx_cart_userId ON Cart(userId);
CREATE INDEX idx_cartItem_cartId ON CartItem(cartId);
CREATE INDEX idx_cartItem_productItemId ON CartItem(productItemId);
CREATE INDEX idx_order_userId ON "Order"(userId);
CREATE INDEX idx_productIngredients_productId ON Product_Ingredients(productId);
CREATE INDEX idx_productIngredients_ingredientId ON Product_Ingredients(ingredientId);
CREATE INDEX idx_cartItemIngredients_cartItemId ON CartItem_Ingredients(cartItemId);
CREATE INDEX idx_cartItemIngredients_ingredientId ON CartItem_Ingredients(ingredientId);
